...
public class AlanColorManager {
	 ...
	 * @since 2.1
	 */
	public AlanColorManager(boolean autoDisposeOnDisplayDispose) {
		fAutoDisposeOnDisplayDispose= autoDisposeOnDisplayDispose;
	}

	@SuppressWarnings("unchecked")
	public void dispose(Display display) {
		Map<String, RGB> colorTable= fDisplayTable.get(display);
		if (colorTable != null) {
